...
class ScheduleItem {
  ...
  final String? status; // Represents swap_request_status or volunteered_cycle_status
  ...
  String get formattedTimeDisplay {
    ...
    switch (shiftType) {
      ...
      case 'Open': return '(Flexible Slot)'; // Keep for historical data display
      case 'Split Double': return '(Split Shift)'; // Keep for historical data display
      case 'Double A': return '(Double Shift)'; // Keep for historical data display
      case 'Double B': return '(Double Shift)'; // Keep for historical data display
      default: return '';
    }
  }
}
